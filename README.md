...
> ✅ **Upgraded to the GA stack — Spring AI 2.0.0 GA · Spring Boot 4.1.0 · Spring Cloud 2025.1.2.** Spring AI **2.0.0-RC1 → 2.0.0 GA is a stabilisation release with no breaking changes for this workshop** — zero application-code edits were required (the RC1 tool-calling migration carries over verbatim). Alongside it, Spring Boot moved **4.0.6 → 4.1.0** (Spring Framework 7.0.8, Spring Security 7.1.0) and Spring Cloud **2025.1.1 → 2025.1.2**. The flagged compatibility question — **Spring Cloud Gateway on Boot 4.1.0** — is empirically confirmed: Gateway Server WebMVC **5.0.2** compiles and verifies on Boot 4.1.0, and the MCP Java SDK rolled RC1 → **2.0.0**. All 43 modules build green (`clean verify`, all tests pass). Full breakdown: **[SPRING_AI_RC1_TO_GA_UPGRADE_PLAN.md](SPRING_AI_RC1_TO_GA_UPGRADE_PLAN.md)**. Prior records: **[SPRING_AI_M8_TO_RC1_UPGRADE_PLAN.md](SPRING_AI_M8_TO_RC1_UPGRADE_PLAN.md)**, **[SPRING_AI_M7_TO_M8_UPGRADE_PLAN.md](SPRING_AI_M7_TO_M8_UPGRADE_PLAN.md)**, **[SPRING_AI_M6_TO_M7_UPGRADE_PLAN.md](SPRING_AI_M6_TO_M7_UPGRADE_PLAN.md)**, **[SPRING_AI_M5_TO_M6_MIGRATION.md](SPRING_AI_M5_TO_M6_MIGRATION.md)**, **[SPRING_AI_M4_TO_M5_MIGRATION.md](SPRING_AI_M4_TO_M5_MIGRATION.md)**.
